#!/bin/bash
# Olmo-3-7B-Think + PW-OPSD Moderate (method=pwopsd) train-only.
#   Output: outputs/olmo3_7b_think_pwopsd/ (LoRA adapter)
#           outputs/olmo3_7b_think_pwopsd_merged/ (merged full model)
#
...
train_and_merge "olmo3_7b_think_pwopsd" \
    --method pwopsd \
    --position_w_min 0.25 \
    --position_tau 0.30 \
    --position_s 0.10
