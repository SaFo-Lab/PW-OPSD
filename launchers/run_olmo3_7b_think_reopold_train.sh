#!/bin/bash
# Olmo-3-7B-Think + REOPOLD baseline (method=reopold) train-only.
#   Output: outputs/olmo3_7b_think_reopold/ (LoRA adapter)
#           outputs/olmo3_7b_think_reopold_merged/ (merged full model)
#
...
train_and_merge "olmo3_7b_think_reopold" \
    --method reopold \
    --reopold_lambda 0.1 \
    --reopold_beta 0.2 \
    --reopold_t_switch 50
