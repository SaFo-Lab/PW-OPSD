#!/bin/bash
# Olmo-3-7B-Think + OPSD baseline (method=opsd): train LoRA adapter and merge
...
train_and_merge() {
  ...
  accelerate launch --config_file "$REPO_ROOT/code/accelerate_4gpu.yaml" \
    ...
    --vllm_gpu_memory_utilization 0.55 --vllm_tensor_parallel_size 1 \
...
train_and_merge "olmo3_7b_think_opsd" --method opsd
