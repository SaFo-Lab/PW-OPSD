...
## Cross-model main result (Avg@12, 38k-token regime, 3 evaluation seeds)

| Base model        | OPSD    | PW-OPSD (ours) | Δ        |
|-------------------|---------|----------------|----------|
| Qwen3-4B          | 70.27   | **70.66**      | **+0.39**|
| DSR1-Llama-8B     | 45.56   | **45.91**      | **+0.35**|
| Olmo-3-7B-Think   | 70.07   | **70.57**      | **+0.50**|

PW-OPSD uses the diagnostic-derived Moderate schedule
`(w_min, tau, s) = (0.25, 0.30, 0.10)`, held fixed across all three
models. Per-benchmark numbers and standard deviations are in the paper.
