#!/bin/bash
# DeepSeek-R1-Distill-Llama-8B + PW-OPSD Moderate (method=pwopsd) train-only.
#   Output: outputs/dsr1_l8b_pwopsd/ (LoRA adapter)
#           outputs/dsr1_l8b_pwopsd_merged/ (merged full model)
#
...
train_and_merge "dsr1_l8b_pwopsd" \
    --method pwopsd \
    --position_w_min 0.25 \
    --position_tau 0.30 \
    --position_s 0.10
