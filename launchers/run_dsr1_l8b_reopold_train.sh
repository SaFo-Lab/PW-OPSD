#!/bin/bash
# DeepSeek-R1-Distill-Llama-8B + REOPOLD baseline (method=reopold) train-only.
#   Output: outputs/dsr1_l8b_reopold/ (LoRA adapter)
#           outputs/dsr1_l8b_reopold_merged/ (merged full model)
#
...
train_and_merge "dsr1_l8b_reopold" \
    --method reopold \
    --reopold_lambda 0.1 \
    --reopold_beta 0.2 \
    --reopold_t_switch 50
